...
5. Inspect the poster for identity, exact spelling, the correct large company or university lockup, no more than two essential role blocks and two topics, the white-left/near-black-right diagonal split, correct event footer, no Marco Pavone/NVIDIA/Stanford remnants for unrelated speakers, and no clipping. Confirm the caption remains unchanged in structure and contains only source-backed facts and exact configured campaign values.
